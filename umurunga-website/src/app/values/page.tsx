...
import { faHeart, faUsers, faDove, faShieldAlt } from "@fortawesome/free-solid-svg-icons";
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            {values.map((value, i) => (
              <div key={i} className="bg-gray-50 rounded-xl p-6 text-center transition-transform duration-300 hover:-translate-y-2 shadow-xl hover:shadow-md">
                <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-[#0064A2]/10 flex items-center justify-center">
                  <FontAwesomeIcon icon={value.icon} className="w-6 h-6" style={{ color: "#0064A2" }} />
                </div>
                <h3 className="font-bold text-[#0064A2] mb-2 text-xl">{value.title}</h3>
